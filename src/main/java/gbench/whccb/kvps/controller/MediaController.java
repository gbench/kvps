...
public class MediaController {
     ...
     * 提取任务定义
     * 
     * http://localhost:8090/snowwhite/media/file/upload
     * 
     * @param file 文件名称
    ...
    public Map<String, Object> upload(@RequestParam("file") MultipartFile file) {
        ...
        final String downloadUrl = IRecord.FT("/snowwhite/media/file/download?key=$0&mimetype=$1",
    ...
    /**
     * 
     * http://localhost:8090/snowwhite/media/file/download?key=E:/slicee/temp/snowwhite/excel/upload/temoc-shrug.png&mimetype=image/png
     * 
     * @param key      键名
     ...
     * 提取任务定义
     * 
     * http://localhost:8090/snowwhite/media/file/write
     * 
     * @param key   文件名称
     * @param lines 文件数据行
     * @return {code,destFile,extension,downlodUrl}
    ...
    public Map<String, Object> write(final String key, final String lines) {
        ...
        final String mimeType = mimetype(extension);
        final String downloadUrl = IRecord.FT("/snowwhite/media/file/download?key=$0&mimetype=$1", path(pathfile),
                mimeType);
     ...
     * 提取任务定义
     * 
     * http://localhost:8090/snowwhite/media/file/list?key=E:/slicee/temp/snowwhite/ufms
     * 
     * @param key 文件名称
     * @return {code,destFile,extension,downlodUrl}
     */
     ...
     * @return [{code,destFile,extension,downlodUrl}]
     */
    public static List<Map<String, Object>> listKey(final String key) {
        ...
        final List<Map<String, Object>> files = listfiles.stream().map(pathfile -> {
            ...
            final String extension = FileSystem.extensionpicker(path);
            final String mimetype = mimetype(extension);
            final String url = IRecord.FT("/snowwhite/media/file/download?key=$0&mimetype=$1", path(pathfile),
                    mimetype);
    ...
    @Value("${excel.upload.home:E:/slicee/temp/snowwhite/excel/upload}")
    private String uploadHome;
    @Value("${excel.output.home:E:/slicee/temp/snowwhite/excel/output}")
